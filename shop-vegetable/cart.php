...
$db = new db();
$connect = $db->connect();
$sql = "SELECT cart.*, name, image, (cart.price * cart.quantity) as total FROM `cart` JOIN 
products ON cart.product_id = products.id WHERE code = $code;";
	    				...
	    				<table class="table">
						    ...
						    <tbody>
						      ...
						      <tr class="text-center">
						        ...
						        <td class="image-prod"><div class="img" style="background-image:url(./CSS/images/<?= $cart->image?>);"> </div></td>
